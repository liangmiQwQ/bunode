...
That said, I don't want to adopt Bun's whole toolchain. I still prefer keep using my existing tools, `pnpm` for workspace management, and the [Vite](https://vite.dev/) ecosystem (including [Vitest](https://vitest.dev/)). And all of them can run on top of Bun as the underlying runtime.
...
My approach is to build a compatible layer, wrap Bun and provide Node.js-compatible API.
